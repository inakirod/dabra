...
const CONFIG = [
  {
    ...
    content:
      'Powering Dabra, SPL Governance is an asset and DAO type agnostic standard for building DAOs on Solana.',
  ...
  },
  {
    ...
    content:
      'Use the shared SPL Governance instance, or use your own for full control and immutability. Clone Dabra to create your own DAO frontend.',
