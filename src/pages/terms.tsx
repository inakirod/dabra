      ...
      <CenteredContent className='px-5 pt-52 pb-6'>
        <div className='mx-auto max-w-4xl space-y-8 text-white/80'>
          ...
          <p>
            ...
            located at www.dabra.app (the &ldquo;
            <strong>
              <em>Site</em>
            </strong>
          ...
          <p>
            ...
            decentralized SPL Governance protocol and for the Dabra Open Source
          ...
          <ol className='list-decimal space-y-8'>
            ...
            <li>
              ...
              <ol className='list-[lower-alpha] space-y-8 pl-4 pt-4'>
                ...
                <li>
                  <span className='underline'>
                    Access to the Dabra Open Source Code.
                  </span>
                  &nbsp;The Interface also provides you with one access point to
                  the Dabra Open Source Code. The Dabra Open Source Code is
                  software source code licensed to the public under the Apache
                  ...
                  any user may record the results of the Dabra Open Source Code
                ...
                <li>
                  ...
                  Dabra does not store or manage these keys.
                </li>
                <li>
            ...
            <li>
              ...
              Site Operator at admin@dabra.app.
            </li>
          </ol>
