    ...
    <div className='landing-page bg-background'>
      ...
      <CenteredContent className='px-5 pt-52 pb-6'>
        <div className='mx-auto max-w-4xl space-y-8 text-white/80'>
          ...
          <p>
            <span>
              This Privacy Notice is designed to help you understand how Dabra
              Today Ltd (“RT,” “we,” “us,”or “our”) collects, uses, processes,
              and shares your personal information on the Dabra Platform
              (https://dabra.app/realms), and to help you understand and
          ...
          <p>
            <span>
              ...
              us on the Dabra Platform (
            </span>
            <span>
              <a className='text-blue-400' href='https://dabra.app/realms'>
                https://dabra.app/realms
              </a>
            </span>
            <span>
            ...
            <ul className='list-disc'>
              <li>
                ...
                <span>
                  ...
                  While this metadata is not collected or stored by Dabra Today
          ...
          <p>
            ...
            <p>
              ...
              <span className='font-bold'>admin@dabra.app</span> and we will
